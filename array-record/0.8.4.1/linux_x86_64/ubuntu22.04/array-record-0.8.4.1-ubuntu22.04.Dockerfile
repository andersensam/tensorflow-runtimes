...
RUN uv pip install auditwheel && \
    ...
    auditwheel repair --plat manylinux_2_35_x86_64 -w repaired_dist dist/*.whl && \
    uv pip install https://github.com/andersensam/tensorflow/releases/download/2.21.0.3/tensorflow-2.21.0.3-cp312-cp312-manylinux_2_35_x86_64.whl repaired_dist/*.whl && \
