...
# Use the cuda-12.8-toolchain image for building TensorFlow I/O (see common/linux_x86_64/ubuntu20.04/cuda-12.8-toolchain)
...
RUN git clone --depth 1 https://github.com/andersensam/tensorflow-io && \
    ...
    uv pip install --no-deps --no-index https://github.com/andersensam/tensorflow/releases/download/2.19.1.4/tensorflow-2.19.1.4-cp312-cp312-manylinux_2_31_x86_64.whl && \
    uv cache clean
...
COPY tfio_0.37.3_ubuntu20.04.brc .bazelrc
