...
RUN git clone --depth 1 https://github.com/andersensam/tensorflow-io && \
    ...
    uv pip install --no-deps --no-index https://github.com/andersensam/tensorflow/releases/download/2.19.1.4/tensorflow-2.19.1.4-cp312-cp312-manylinux_2_35_x86_64.whl && \
    uv cache clean
