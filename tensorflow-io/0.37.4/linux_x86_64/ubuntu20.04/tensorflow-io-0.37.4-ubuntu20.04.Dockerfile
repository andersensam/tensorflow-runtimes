...
RUN git clone --depth 1 --branch tensorflow_r2.21.0.1 https://github.com/andersensam/tensorflow-io && \
    ...
    uv pip install --no-deps --no-index https://github.com/andersensam/tensorflow/releases/download/2.21.0.3/tensorflow-2.21.0.3-cp312-cp312-manylinux_2_31_x86_64.whl  && \
    uv cache clean && \
...
COPY tfio_0.37.4_ubuntu20.04.brc .bazelrc
