...
# Use the CUDA 12.9 runtime image (for TensorFlow) (cuda-12.9-toolchain-ubuntu20.04.Dockerfile)
...
COPY tf_r2.21.0.3_ubuntu20.04_arm64.brc .tf_configure.bazelrc
ENV HERMETIC_PYTHON_VERSION=3.12
RUN --mount=type=cache,target=/root/.cache/bazel,id=bazel-cache-r2.21.0.3-ubuntu20.04-arm64 \
    bazel clean --expunge
