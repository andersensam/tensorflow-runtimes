...
ARG BASE_IMAGE=cuda-12.9-toolchain:ubuntu22.04
    
# Use the cuda-12.9-toolchain image for building TensorFlow (see common/linux_x86_64/ubuntu22.04/cuda-12.9-toolchain)
...
COPY tf_r2.19.1.4_ubuntu22.04.brc .tf_configure.bazelrc
RUN --mount=type=cache,target=/root/.cache/bazel,id=bazel-cache-r2.19.1.4-ubuntu22.04 \
